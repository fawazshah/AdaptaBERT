...
num_sentences_articles_dist.drop(num_sentences_articles_dist[num_sentences_articles_dist.index > 15].index, inplace=True)
...
plt.xticks(np.arange(1, 50, 5), rotation=0)
